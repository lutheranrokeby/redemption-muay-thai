...
export default function HomePage({ data, onChange, onImageUpload, onClassChange, onClassImageUpload, onAddBentoCard, onDeleteBentoCard, isAdmin }) {
  if (!data) return null;
  ...
  return (
    <div className={isAdmin ? 'edit-mode' : ''}>
      ...
      <Footer data={data.footer} onChange={onChange} isAdmin={isAdmin} />
    </div>
  );
}
